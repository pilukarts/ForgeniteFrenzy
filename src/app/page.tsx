  ...
  return (
    <AppLayout>
      ...
      >
        ...
        <div className="relative z-30 w-full flex flex-col items-center justify-start flex-grow">
        ...
        <div className="relative z-30 flex flex-col items-center justify-center flex-grow">
        ...
        <div className="relative z-30 w-full flex justify-between items-end p-2 sm:p-4">
          <motion.div 
          ...
          >
            ...
            <Button onClick={switchCommanderSex} variant="outline" size="sm" className="w-full justify-start">
          ...
          <motion.div 
            ...
            animate={{ x: 0, opacity: 1 }}
            transition={{ delay: 0.5, type: 'spring', stiffness: 50 }}
            className="flex flex-col gap-2 w-auto max-w-[120px] sm:max-w-[150px] items-end"
          >
            <div className="flex items-center gap-2 p-2 rounded-md border border-input bg-background">
