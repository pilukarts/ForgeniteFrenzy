  ...
  return (
    <AppLayout>
      ...
      >
        ...
        {/* Action Buttons and Commander on the Sides */}
        <div className="absolute bottom-0 left-0 right-0 w-full flex justify-between items-end px-2 sm:px-4 z-30 pointer-events-none pb-2">
            ...
            {/* Right Side Column (Commander + Buttons) */}
            <div className="flex flex-col items-end pointer-events-auto">
                ...
                <motion.div 
                    ...
                    animate={{ x: 0, opacity: 1 }}
                    transition={{ delay: 0.5, type: 'spring', stiffness: 50 }}
                    className="flex flex-col gap-2 w-auto max-w-[120px] sm:max-w-[150px] items-end pointer-events-auto text-right mt-4"
                >
