    ...
    <AppLayout>
      ...
      >
        <CommanderPortrait 
          ...
          onTap={handleTap} 
        />
        <p className="mt-20 text-xl font-semibold text-primary font-headline bg-background/70 p-1 rounded">
