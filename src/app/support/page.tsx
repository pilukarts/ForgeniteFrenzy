...
import { PAYPAL_DONATION_URL, KOFI_DONATION_URL } from '@/lib/gameData';
            ...
            <CardContent className="flex flex-col space-y-3">
              <a href={PAYPAL_DONATION_URL} target="_blank" rel="noopener noreferrer">
               ...
               <a href={KOFI_DONATION_URL} target="_blank" rel="noopener noreferrer">
                <Button className="w-full bg-[#13C3FF] hover:bg-[#00A9E0] text-black text-base font-semibold">
                  <Coffee className="mr-2 h-5 w-5" />
                  Buy me a coffee on Ko-fi
                </Button>
              </a>
              <p className="text-xs text-muted-foreground mt-3 text-center">
                You will be redirected to the official donation website. These are real donation links.
              </p>
            </CardContent>
          </Card>
