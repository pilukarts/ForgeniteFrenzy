...
const ArkForgePanel: React.FC<Props> = ({ countdown = "30d 0h 0m", className = "" }) => {
  return (
    <div className={`w-60 sm:w-72 rounded-2xl p-5 bg-black/60 backdrop-blur-2xl border border-white/20 shadow-[0_0_60px_rgba(0,0,0,0.9)] transition-all duration-500 hover:border-primary/40 ${className}`}>
      <div className="flex flex-col items-center gap-5">
        {/* Contenedor de la nave con efecto de muelle de construcción (Hangar) */}
        <div className="w-full aspect-square relative bg-gradient-to-br from-blue-950/40 via-black to-gray-900 rounded-xl overflow-hidden border border-white/10 group min-h-[160px]">
          <Image
            src={images.ark.ark}
            alt="Ark Forge Ship"
            fill
            unoptimized={true}
            className="object-contain p-5 drop-shadow-[0_0_40px_rgba(255,215,0,0.5)] transition-transform duration-1000 group-hover:scale-105"
            draggable={false}
          ...
          <div className="absolute top-0 left-0 w-full h-[2px] bg-primary/90 shadow-[0_0_25px_rgba(255,215,0,1)] animate-[scan_5s_linear_infinite] z-20" />
        ...
        <div className="w-full text-center space-y-2">
          <div className="text-[11px] uppercase tracking-[0.3em] text-primary/90 font-headline font-bold">Ark-Forge Status</div>
