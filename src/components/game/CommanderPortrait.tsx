  ...
  return (
    ...
    >
      ...
      <svg
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[170%] h-10 w-10 md:h-12 md:w-12 text-bright-gold/70 opacity-80 pointer-events-none core-hexagon-glow"
      >
        <path
